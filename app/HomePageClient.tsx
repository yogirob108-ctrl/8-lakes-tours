    ...
    <>
      ...
      <div className="hero" id="top">
        <div className="hero-bg">
          ...
          >
            <source src="/videos/orkhon-valley-drone-loop-mobile.mp4?v=5" type="video/mp4" media="(max-width: 900px)" />
            <source src="/videos/orkhon-valley-drone-loop.mp4?v=5" type="video/mp4" />
          </video>
        </div>
