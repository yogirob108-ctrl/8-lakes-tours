    ...
    <main className="about-page">
      ...
      <section className="intro-grid">
        ...
        <div className="intro-copy">
          ...
          <p>Plans change out here. Weather, distance, and the animals decide a lot of the day. But the old customs of hospitality are still very much alive. Ride up to a ger and you&apos;ll be offered tea and a place to sit, and when things don&apos;t go to plan, there&apos;s always someone willing to help.</p>
        </div>
      </section>
