...
export async function GET(request: Request) {
 ...
 // Explicit rollout switch; never enable or send during a code-only release.
 if(process.env.ABANDONED_CHECKOUT_RECOVERY_ENABLED!=='true') return Response.json({enabled:false},{headers});
 try {
