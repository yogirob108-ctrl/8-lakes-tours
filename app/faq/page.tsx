...
const FAQ_ITEMS = [
  ...
  ['What departure dates are available?', 'The website shows the currently bookable departures for both seasons and automatically removes dates once they begin. The 2026 season runs to late October, and the 2027 season runs fortnightly from early May to late October. Both book and pay online the same way. Book a 2027 departure while the 2026 season is still running and you keep the founding rate. A private group date of your own choosing remains available on request. Each departure is capped at 8 guests and final availability depends on host-family, horse, guide, and group logistics.'],
