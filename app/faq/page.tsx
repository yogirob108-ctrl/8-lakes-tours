  ...
  return (
    <main style={pageStyle}>
      ...
      <style>{`
        ...
        .page-hero-media { position: absolute; inset: 0; background: #0e0c09 url('/videos/faq-horse-mane-poster.jpg?v=2') center / cover no-repeat; }
        ...
        @media (max-width: 900px) { .page-hero-media { background-image: url('/videos/faq-horse-mane-poster-mobile.jpg?v=2'); } }
      ...
      <header className="page-hero">
        <div className="page-hero-media" role="img" aria-label="Close-up of a Mongolian horse&apos;s mane and eye">
          <HeroVideo className="page-hero-video" desktopSrc="/videos/faq-horse-mane-loop.mp4?v=2" mobileSrc="/videos/faq-horse-mane-loop-mobile.mp4?v=2" />
