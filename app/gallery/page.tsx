    ...
    <main className="gallery-page">
      ...
      <header className="gallery-hero">
        <div className="gallery-hero-media" role="img" aria-label="Horses drinking at a river with clouds reflected on the water">
          <HeroVideo className="gallery-hero-video" desktopSrc="/videos/gallery-river-horses-loop.mp4?v=5" mobileSrc="/videos/gallery-river-horses-loop-mobile.mp4?v=5" />
      ...
      <style>{`
        ...
        .gallery-hero-media { position: absolute; inset: 0; background: #0e0c09 url('/videos/gallery-river-horses-poster.jpg?v=5') center / cover no-repeat; }
        ...
        @media (max-width: 900px) { .gallery-hero-media { background-image: url('/videos/gallery-river-horses-poster-mobile.jpg?v=5'); } }
