      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '5rem 2rem' }}>
        ...
        {[
          ...
          },
          {
            ...
            body: 'When you begin the booking form, after you provide your name and email, we save a limited encrypted-in-transit checkout draft so you can recover an interrupted form. Drafts are not bookings, are not shared with other visitors, are deleted after 30 days, and may receive one transactional reminder to complete checkout only after a delayed eligibility check. We do not collect card data in a draft. When you complete the booking form, we collect passport-matching names, date of birth, nationality, riding experience, dietary information, and optional gender for each traveller, plus optional companion email and phone details. The lead booker supplies companion details for trip operations and confirms they have each companion’s permission to provide their details. We also collect the lead traveller’s contact and emergency contact details, preferred tour date, additional notes, and typed digital signature. The typed signature records the lead booker’s own waiver agreement only; it is not treated as a waiver signed by every companion.',
          },
          {
