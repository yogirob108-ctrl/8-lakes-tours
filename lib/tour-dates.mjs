...
export const FOUNDING_RATE_NOTE = 'Take a 2027 date while the 2026 season is still riding and you hold this year’s price.';
export const FOUNDING_RATE_HEADING = 'Claim the founding rate';
export const FOUNDING_RATE_CLOSER = 'Your date, your price, settled today.';
