...
- Recovery email is a single private transactional reminder, signed Rob & the 8 Lakes Tours team, without names/manifest/DOB/marketing. Its link uses the existing script-free private recovery route; opening email/link does not create a Stripe Session. Payment link POST keeps shared public/Ops Checkout ownership.
