...
function harness(enabled='true') {
 ...
 vm.runInNewContext(code,{exports,Buffer,Response,process:{env:{CRON_SECRET:'local-only',STRIPE_SECRET_KEY:'local-fixture',ABANDONED_CHECKOUT_RECOVERY_ENABLED:enabled}},require(name){
